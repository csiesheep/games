...
// whole subdomain (one file covers every game underneath it). Whatever
// publisher id is listed here must match the ca-pub-... the pages actually
// request ads with, or Google withholds creatives.
const ADS_TXT =
  "#ads.txt generated by Easy Google AdSense plugin\n" +
  "google.com, pub-1718750784240290, DIRECT, f08c47fec0942fa0\n";
...
const ROBOTS_TXT =
  ...
  "Sitemap: " + ORIGIN + "/the_resistance/sitemap.xml\n";
...
const SITEMAP_URLS = [
  ...
  { loc: ORIGIN + "/the_resistance/", lastmod: "2026-09-11", priority: "0.8" },
];
const SITEMAP_XML =
